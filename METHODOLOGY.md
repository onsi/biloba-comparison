...
[`README.md`](./README.md). This is a deliberately
...
```
README.md           high-level overview + measured results
...
The figures in `README.md` are SVGs under `charts/`, generated by the stdlib-only
